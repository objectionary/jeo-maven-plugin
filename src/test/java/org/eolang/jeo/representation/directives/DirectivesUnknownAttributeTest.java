    ...
    void convertsToCorrectXmir() throws ImpossibleModificationException {
        MatcherAssert.assertThat(
            ...
            XhtmlMatchers.hasXPaths(
                ...
                "/o[@name='a0']/o[@base='Φ.string' and @name='type']",
                "/o[@name='a0']/o[@base='Φ.string' and @name='type']/o[@base='Φ.bytes']",
                "/o[@name='a0']/o[@base='Φ.string' and @name='type']/o[@base='Φ.bytes']/o[text()='53-6F-6D-65-2D-54-79-70-65']",
                "/o[@name='a0']/o[@name='data']",
                "/o[@name='a0']/o[@name='data']/o[@base='Φ.jeo.bytes' and @name='φ']",
                "/o[@name='a0']/o[@name='data']/o[@base='Φ.bytes' and @name='j0']",
                "/o[@name='a0']/o[@name='data']/o[@base='Φ.bytes' and @name='j0']/o[text()='00-01-02-03-04-05']"
            )
        );
    }
}

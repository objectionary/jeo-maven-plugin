 ...
 *
 * <p>The plugin supports optional bytecode verification to ensure generated classes are valid and
 * can be loaded by the JVM.</p>
 *
 * @since 0.1.0
 */
...
public final class AssembleMojo extends AbstractMojo {
     ...
     *
     * <p>Provides access to project configuration and dependencies required for bytecode
     * verification.</p>
     *
     * @since 0.2.0
     */
     ...
     *
     * <p>This directory should contain EO files in XMIR format that represent Java bytecode
     * instructions. These files are typically generated by the disassemble goal.</p>
     *
     * @since 0.2.0
     ...
     *
     * <p>All assembled class files will be written to this directory, preserving the package
     * structure as defined in the source XMIR files.</p>
     *
     * @since 0.2.0
     * @checkstyle MemberNameCheck (6 lines)
     */
     ...
     *
     * <p>By default, all generated bytecode is verified to ensure it conforms to JVM
     * specifications and can be loaded without errors. Set this parameter to {@code true} to
     * skip verification, which may speed up the build but could result in invalid class files.</p>
     *
     * @since 0.2.0
     * @checkstyle MemberNameCheck (6 lines)
     */
     ...
     *
     * <p>When enabled, verifies all XMIR files for structural integrity and correctness before
     * attempting to assemble them into bytecode. If any XMIR file is invalid or corrupted, the
     * build process will fail. This verification is disabled by default for performance.</p>
     *
     * @since 0.8.0
     * @checkstyle MemberNameCheck (6 lines)
     */

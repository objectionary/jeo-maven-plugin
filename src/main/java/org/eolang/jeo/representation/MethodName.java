 ...
 *
 * <p>This class handles the conversion of Java method names, particularly special cases like
 * constructors and static initializers. Constructor names are represented as '&lt;init&gt;' in
 * bytecode which isn't allowed in EO, so they need to be converted to valid EO names and back.</p>
 *
 * @since 0.6.0
 */
